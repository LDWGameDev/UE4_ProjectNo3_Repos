...
UPlayerHumanState_AssassinHA_C3_2::UPlayerHumanState_AssassinHA_C3_2()
{
	...
	m_Hitboxes_05.Add(FStruct_SphereTrace_Offset(FVector(-200.0f, 120.0f, 0.0f), FVector(-200.0f, 120.0f, -30.0f), 80.0f));
}
...
void UPlayerHumanState_AssassinHA_C3_2::EnterState()
{
	...
	{
		m_CharPlayerHuman_Owner->SetViewToCameraSequence(FName("Sequence_HA_C3_2"), true);
		m_CharPlayerHuman_Owner->PlayMontageFromTable(FName(TEXT("Assassin_HeavyAttack_C3_2")));
	}
	else 
	{
		SetCameraFollow_01(c_AdditionArmLength, c_SocketOffset, 0.3f, -10.0f, 60.0f, FVector(0.0f, -40.0f, 0.0f), FVector(0.0f, -40.0f, 0.0f));
		m_CharPlayerHuman_Owner->PlayMontageFromTable(FName(TEXT("Assassin_HeavyAttack_C3_2_Type2")));
	}
}
...
void UPlayerHumanState_AssassinHA_C3_2::BindInputHandlingFunctions(AController* p_PlayerController)
{
	...
	if (m_AnimNotify_01_DelegateREF != nullptr) m_AnimNotify_01_DelegateREF->AddUObject(this, &UPlayerHumanState_AssassinHA_C3_2::HandleAction_AnimNotify_01);
	if (m_AnimNotify_02_DelegateREF != nullptr) m_AnimNotify_02_DelegateREF->AddUObject(this, &UPlayerHumanState_AssassinHA_C3_2::HandleAction_AnimNotify_02);
	if (m_EndAttack_02_DelegateREF != nullptr) m_EndAttack_02_DelegateREF->AddUObject(this, &UPlayerHumanState_AssassinHA_C3_2::HandleAction_EndAttack_02);
...
void UPlayerHumanState_AssassinHA_C3_2::HandleAction_AnimNotify_01()
{
	if (!b_IsInState) return;
	b_CanBreakOut = true;
}

void UPlayerHumanState_AssassinHA_C3_2::HandleAction_AnimNotify_02()
{
	
}

void UPlayerHumanState_AssassinHA_C3_2::HandleAction_EndAttack_02()
{
	if (!b_IsInState) return;
