...
#include "PlayerHumanState_AssassinJump.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNO3_API UPlayerHumanState_AssassinJump : public UPlayerHuman_BaseState
{
	GENERATED_BODY()
...
protected:
private:
	const float c_JumpForce = 1100.0f;
	const float c_ArmLengthFollow_01 = -30.0f;
 ...
 */
public:
	UPlayerHumanState_AssassinJump();
