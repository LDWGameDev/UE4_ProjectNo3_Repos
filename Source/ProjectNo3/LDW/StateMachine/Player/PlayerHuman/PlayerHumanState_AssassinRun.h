...
#include "PlayerHumanState_AssassinRun.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNO3_API UPlayerHumanState_AssassinRun : public UPlayerHuman_BaseState
{
	GENERATED_BODY()
...
protected:
private:
	const float c_BackToJogSpeed = 200.0f;
	const float c_MovingSpeed = 700.0f;
	const float c_AdditionalArmLengthFollow_01 = 80.0f;
