...
void UPlayerHumanState_AssassinDash_2::HandleAnimNotify_AnimNotify_01()
{
	Super::HandleAnimNotify_AnimNotify_01();
	b_CanBreakOut = true;
}

void UPlayerHumanState_AssassinDash_2::HandleAnimNotify_EndMontage()
{
	...
	UE_LOG(LogTemp, Warning, TEXT("AssassinDash_2State HandleAnimNotify_EndMontage() triggered"));
}
